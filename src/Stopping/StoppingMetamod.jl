...
function StoppingMeta(tol_check           :: CheckType,
...
function toltype(meta :: StoppingMeta{TolType, CheckType, MUS, IntType}
                   ) where {TolType, CheckType, MUS, IntType}
  return TolType
end

function metausertype(meta :: StoppingMeta{TolType, CheckType, MUS, IntType}
                   ) where {TolType, CheckType, MUS, IntType}
  return MUS
end

function inttype(meta :: StoppingMeta{TolType, CheckType, MUS, IntType}
                   ) where {TolType, CheckType, MUS, IntType}
  return IntType
end
