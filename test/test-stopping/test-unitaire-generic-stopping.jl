@testset "Test GenericStopping" begin
    ...
    substop = GenericStopping(rosenbrock, StopRemoteControl(), state1, main_stp = stop, max_iter = ABigInt, rtol = 0.0 )
    ...
    #
    subsubstop = GenericStopping(rosenbrock, StopRemoteControl(), state1, main_stp = substop, max_iter = ABigInt, rtol = 0.0 )
    #If rtol != 0, any point is a solution as optimality0 = Inf.
